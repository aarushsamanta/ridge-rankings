...
import { u as useAuth, M as MatchHistory, s as supabase } from "./router-0q_hDKUs.mjs";
import { L as Layout, S as SignInGate } from "./SignInGate-gOllkBy2.mjs";
...
function ProfilePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileContent, { email: user.email, isAdmin }) });
}
function ProfileContent({
  ...
  const {
    ...
    queryFn: async () => {
      const {
        data
      } = await supabase.from("players").select("*").ilike("email", email).maybeSingle();
      return data;
    }
  });
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground", children: "Loading…" });
  if (!player) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto text-center py-16 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 mx-auto rounded-2xl bg-primary/15 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-8 h-8 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl", children: "No player profile" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
        "You're signed in as ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: email }),
        ", but you're not registered on the leaderboard yet. Ask an admin to add you."
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl mb-4", children: "My Matches" }),
